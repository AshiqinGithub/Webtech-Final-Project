...
var password1 = document.updateform.pass.value;
var password2 = document.updateform.pass2.value;
...
function checkfName()
{
	...
	else if(!namepattern.test(document.updateform.fname.value))
	{
		fnameErr.style.color = "red";
...
function checklName()
{
	...
	else if(!namepattern.test(document.updateform.lname.value))
	{
		lnameErr.style.color = "red";
...
function checkuName()
{
	...
	else if(!uformat.test(document.updateform.username.value))
	{
		usererr.style.color = "red";
...
function checkEmail()
{
	...
	else if(!emailpattern.test(document.updateform.email.value))
	{
		emailErr.style.color = "red";
...
function checkPass1()
 ...
 function checkPass2()
 {
 	...
 	if(pass2.value == "")
 	{
 		...
 		pass2err.innerHTML = "Please re-type password";
...
{
	jQuery.ajax({
			url:"../controller/livemailcheckedit.controller.php",
